...
This small fixture demonstrates a representative set of deterministic Flowplane transformations. It is designed for quick simulation or runtime smoke testing. Start with [Operations and transformations](../../docs/operations-and-transformations.md), then use the [complete operations reference](../../docs/operations-reference.md) for every supported option.
